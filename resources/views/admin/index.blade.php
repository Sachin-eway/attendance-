	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				...
				<!--</div>-->
				<div>
					<h4 class="logo-text">Attendance</h4>
				</div>
			...
			<ul class="metismenu" id="menu">
				...
				<li class="{{ request()->is('employee') || request()->is('addEmployee') ? 'mm-active' : '' }}">
					<a href="{{url('employee')}}">
				...
				<li class="{{ request()->is('attendance') ? 'mm-active' : '' }}">
				...
				<nav class="navbar navbar-expand">
					...
					<div class="user-box dropdown">
						<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							<img src="https://i.pinimg.com/736x/0d/64/98/0d64989794b1a4c9d89bff571d3d5842.jpg" class="user-img" alt="user avatar">
     ...
     $('.submit-form').submit(function(e){
        ...
        $.ajax({
            ...
            success: function(response){
               from.find('input').nextAll('span').remove();
            ...
            statusCode: {
                422: function (data) {
                    from.find('input').next('span').remove();
                    $.each(data.responseJSON.error, function (key, value) {
                        console.log(!from.find('input[name="' + key + '"]').next('span'))
                        from.find('input[name="' + key + '"]').after('<span class="text-danger">' + value + '</span>');
                    });
                },
            }
        });
